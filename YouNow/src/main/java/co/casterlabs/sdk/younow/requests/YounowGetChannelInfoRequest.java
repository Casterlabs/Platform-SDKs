...
public class YounowGetChannelInfoRequest extends WebRequest<YounowChannel> {
    ...
    protected YounowChannel execute() throws ApiException, ApiAuthException, IOException {
        String response = WebRequest.sendHttpRequest(
            new Request.Builder()
                .url("https://cdn.younow.com/php/api/channel/getInfo/includeUserKeyWords=1/user=" + this.username),
            null
        );
