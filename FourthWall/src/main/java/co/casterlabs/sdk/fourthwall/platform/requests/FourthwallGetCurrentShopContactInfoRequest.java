...
import co.casterlabs.sdk.fourthwall.platform.types.FourthwallShopContactInfo;
...
public class FourthwallGetCurrentShopContactInfoRequest extends AuthenticatedWebRequest<FourthwallShopContactInfo, FourthwallAuth> {

    public FourthwallGetCurrentShopContactInfoRequest(@NonNull FourthwallAuth auth) {
        super(auth);
    }
