...
import co.casterlabs.trovoapi.requests.TrovoGetChannelFollowersRequest.TrovoGetChannelFollowersResponse;
import co.casterlabs.trovoapi.requests.data.TrovoFollower;
