...
public class TwitchHelixGetChannelFollowerCountRequest extends AuthenticatedWebRequest<Long, TwitchHelixAuth> {
    private @NonNull String forBroadcasterId;

    public TwitchHelixGetChannelFollowerCountRequest(@NonNull TwitchHelixAuth auth) {
        super(auth);
    }
