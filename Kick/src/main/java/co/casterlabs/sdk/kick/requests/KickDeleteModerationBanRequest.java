...
public class KickDeleteModerationBanRequest extends AuthenticatedWebRequest<KickPostedChatMessage, KickAuth> {
    private @Setter Integer forChannelId = null;
    private @Setter Integer forUserId = null;

    public KickDeleteModerationBanRequest(@NonNull KickAuth auth) {
        super(auth);
    }
    ...
    protected KickPostedChatMessage execute() throws ApiException, ApiAuthException, IOException {
        ...
        return _KickApi.request(
            HttpRequest.newBuilder(URI.create(url))
                .method("DELETE", BodyPublishers.ofString(payload.toString()))
