...
public class KickLivestream {
    public static final TypeToken<KickLivestream[]> ARRAY_TYPE = TypeToken.of(KickLivestream[].class);
    public static final TypeToken<List<KickLivestream>> LIST_TYPE = new TypeToken<List<KickLivestream>>() {
    };
