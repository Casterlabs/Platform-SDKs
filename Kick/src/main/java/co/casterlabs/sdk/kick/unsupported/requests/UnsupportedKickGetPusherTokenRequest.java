...
public class UnsupportedKickGetPusherTokenRequest extends AuthenticatedWebRequest<String, UnsupportedKickAuth> {
    private @Setter String pusherChannel;
    private @Setter String socketId;

    public UnsupportedKickGetPusherTokenRequest(@NonNull UnsupportedKickAuth auth) {
        super(auth);
    }
    ...
    protected String execute() throws ApiException, ApiAuthException, IOException {
        ...
        JsonObject body = WebRequest.sendHttpRequest(
            HttpRequest.newBuilder()
                .uri(URI.create(UnsupportedKickApi.API_BASE_URL + "/broadcasting/auth")) // Pretty silly name for this, if you ask me.
