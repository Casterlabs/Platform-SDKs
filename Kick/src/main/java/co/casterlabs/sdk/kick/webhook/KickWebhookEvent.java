...
import co.casterlabs.sdk.kick.webhook.v1.types.KickWebhookChannelRewardRedemptionUpdatedV1;
import co.casterlabs.sdk.kick.webhook.v1.types.KickWebhookChatMessageV1;
import co.casterlabs.sdk.kick.webhook.v1.types.KickWebhookKicksGiftedV1;
import co.casterlabs.sdk.kick.webhook.v1.types.KickWebhookLivestreamMetadataUpdatedV1;
import co.casterlabs.sdk.kick.webhook.v1.types.KickWebhookLivestreamStatusUpdatedV1;
import co.casterlabs.sdk.kick.webhook.v1.types.KickWebhookModerationBannedV1;
...
public interface KickWebhookEvent {
   ...
   CHANNEL_REWARD_REDEMPTION_UPDATED_V1 ("channel.reward.redemption.updated", 1, KickWebhookChannelRewardRedemptionUpdatedV1.class),
           LIVESTREAM_STATUS_UPDATED_V1 ("livestream.status.updated",         1, KickWebhookLivestreamStatusUpdatedV1.class),
         LIVESTREAM_METADATA_UPDATED_V1 ("livestream.metadata.updated",       1, KickWebhookLivestreamMetadataUpdatedV1.class),
                   MODERATION_BANNED_V1 ("moderation.banned",                 1, KickWebhookModerationBannedV1.class),
                        KICKS_GIFTED_V1 ("kicks.gifted",                      1, KickWebhookKicksGiftedV1.class),
        // @formatter:on
        ;
